...
class TestCSVIntegration:
    """Integration test checking that IngestionPipeline can parse a CSV file."""
    ...
    async def test_csv_file_ingestion(
        ...
        with tempfile.NamedTemporaryFile(mode="w+", suffix=".csv", delete=False, encoding="utf-8") as f:
            f.write("id,trace,amount,status,date\n")
            f.write("TXN_CSV1,TRACE_CSV1,250.00,Thành công,2024-07-07\n")
            f.write("TXN_CSV2,TRACE_CSV2,500.00,Thất bại,2024-07-07\n")
            csv_path = f.name
